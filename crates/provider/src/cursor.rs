...
const DEFAULT_MODEL: &str = "claude-4-sonnet";

pub fn cursor_models() -> Vec<ModelInfo> {
    vec![
        ModelInfo {
            id: "claude-4-sonnet".into(),
        ...
        ModelInfo {
            id: "claude-4.5-sonnet-thinking".into(),
            name: "Claude 4.5 Sonnet Thinking".into(),
            provider: "cursor".into(),
            context_window: 200_000,
            max_output_tokens: 64_000,
            supports_tools: true,
            ...
            cache_write_price_per_m: 0.0,
            tier: ModelTier::High,
            thinking: Some(ThinkingSupport::BudgetTokens {
                max: 32_768,
                default: 16_000,
            }),
        },
        ModelInfo {
            id: "claude-4.5-opus-high".into(),
        ...
        ModelInfo {
            id: "claude-4.5-opus-high-thinking".into(),
            name: "Claude 4.5 Opus Thinking".into(),
            provider: "cursor".into(),
            context_window: 200_000,
            max_output_tokens: 64_000,
            supports_tools: true,
